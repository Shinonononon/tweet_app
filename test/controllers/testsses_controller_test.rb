...
class TestssesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create testss" do
    assert_difference('Testss.count') do
      post testsses_url, params: { testss: { content: @testss.content, title: @testss.title } }
    end
  ...
  test "should update testss" do
    patch testss_url(@testss), params: { testss: { content: @testss.content, title: @testss.title } }
